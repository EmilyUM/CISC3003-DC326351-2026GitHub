...
function build_mailer(bool $debug): PHPMailer
{
    if (MAIL_FROM_ADDRESS === '' || MAIL_TO_ADDRESS === '' || SMTP_USERNAME === '' || SMTP_PASSWORD === '') {
        throw new RuntimeException('Missing SMTP settings. Please fill php/config.local.php (SMTP_USERNAME/SMTP_PASSWORD/MAIL_FROM_ADDRESS/MAIL_TO_ADDRESS).');
    }
